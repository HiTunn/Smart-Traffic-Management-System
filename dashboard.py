...
# Init Tracker
#D:/Tunf/NOO/DATN/yolov8_tracking/weights/best_v8s.pt
tracker = Tracker(classes=[2, 3, 5, 7],filter_classes= None, ckpt='D:/Tunf/NOO/DATN/Traffic-Flow-Analysis/weights/yolov8n.pt')
...
class VideoCamera(object):
    def __init__(self):
        ...
        self.path = 'D:/Tunf/NOO/DATN/Traffic-Flow-Analysis/3.mp4'
    ...
    def get_frame(self):
        ...
        if success:
            ...
            image, bbox, data = tracker.update(image)
            # print("bboxxxxxxxxxxxxxxxxxxxxxxx\n",bbox)
...
header = dbc.Col(width = 10,
   children = [
    ...
    #        'color':'white;'
    #        }, 
           children = [ html.H1("Smart Traffic Management System", style = {
           'text-align':'center',
           'font-size':'4rem',
           'font-weight':'bold',
...
modelmapping = {
    'YOLOV8n' : {'Name' : 'yolov8n', 'path' : 'weights/yolov8n.pth'},
}
...
def retrack(n_clicks, model_name):
    ...
    global Main
    if n_clicks:
        tracker = Tracker(classes=[2, 3, 5, 7],filter_classes= None, ckpt=modelmapping[model_name]['path'])
        Main = []
    return None
...
app.layout = html.Div([
    ...
    dbc.Row(header, style = {"text-align":"center"}),
